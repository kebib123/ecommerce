...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" media="screen" href="{{asset('themes-assets/vendor/simplebar/dist/simplebar.min.css')}}"/>
    <link rel="stylesheet" media="screen" href="{{asset('themes-assets/vendor/tiny-slider/dist/tiny-slider.css')}}"/>
    <link rel="stylesheet" media="screen" href="{{asset('themes-assets/vendor/drift-zoom/dist/drift-basic.min.css')}}"/>
    <link rel="stylesheet" media="screen" href="{{asset('themes-assets/vendor/lightgallery.js/dist/css/lightgallery.min.css')}}"/>
    <link rel="stylesheet" media="screen" href="{{asset('themes-assets/vendor/nouislider/distribute/nouislider.min.css')}}"/>
      ...
      <div class="navbar navbar-expand-lg navbar-light bg-light navbar-sticky">
        <div class="container"><a class="navbar-brand d-none d-sm-block mr-4 order-lg-1" href="index.php" style="min-width: 7rem;"><img width="142" src="img/logo-dark.png" alt="Cyberlink"/></a><a class="navbar-brand d-sm-none mr-2 order-lg-1" href="index.php" style="min-width: 4.625rem;"><img width="74" src="img/logo-icon.png" alt="Cyberlink"/></a>
          ...
          <div class="navbar-toolbar d-flex align-items-center order-lg-3">
            ...
            <div class="navbar-tool dropdown ml-2 mr-2"><a class="navbar-tool-icon-box border dropdown-toggle" href="account-orders.php"><i class="czi-user"></i></a><a class="navbar-tool-text ml-n1" href="account-orders.php"><small>My Account</small>Hi Susan</a>
              ...
              <div class="dropdown-menu dropdown-menu-right" style="min-width: 14rem;">
                ...
                <a class="dropdown-item d-flex align-items-center" href="account-orders.php"><i class="czi-bag opacity-60 mr-2"></i>Orders <span class="font-size-xs text-muted ml-auto">4</span></a>

                
                <a class="dropdown-item d-flex align-items-center" href="account-wishlist.php"><i class="czi-heart opacity-60 mr-2"></i>Wishlist<span class="font-size-xs text-muted ml-auto">4</span></a>
                ...
                <a class="dropdown-item d-flex align-items-center" href="account-profile.php"><i class="czi-user opacity-60 mr-2"></i>Profile info </a>


                <a class="dropdown-item d-flex align-items-center" href="account-address.php"><i class="czi-location  opacity-60 mr-2"></i>Addresses </a>
                ...
                <div class="dropdown-divider"></div><a class="dropdown-item d-flex align-items-center" href="account-signin.php"><i class="czi-sign-out opacity-60 mr-2"></i>Sign Out</a>
              </div>
            </div>
                          ...
                          <div class="mega-dropdown-column py-4 px-3">
                            <div class="widget widget-links">
                              ...
                              <ul class="widget-list">
                                <li class="widget-list-item pb-1"><a class="widget-list-link" href="{{'/product-list'}}">Laptops &amp; Tablets</a></li>
