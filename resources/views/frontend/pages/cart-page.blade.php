          ...
          <div class="d-sm-flex justify-content-between align-items-center my-4 pb-3 border-bottom">
            ...
            <div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left" style="max-width: 9rem;">
              <div class="form-group mb-0">
                ...
                <input class="form-control" name="quantity[]" min="1" type="number" id="quantity1" value="{{$value->qty}}">
              </div>
              ...
              @endforeach
          <!-- Item-->
          <button class="update_cart btn btn-outline-accent btn-block" type="submit"><i class="czi-loading font-size-base mr-2"></i>Update cart</button>
            </form>
...
{{--                </div>--}}
{{--              </div>--}}
            </div><a class="btn btn-primary btn-shadow btn-block mt-4" href="{{route('checkout-address')}}"><i class="czi-card font-size-lg mr-2"></i>Proceed to Checkout</a>
          </div>
        </aside>
      </div>
    </div>
