...
@section('content')
                ...
                <div class="cz-sidebar rounded-lg box-shadow-lg" id="shop-sidebar">
                    ...
                    <div class="cz-sidebar-body">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <h3 class="accordion-heading"><a class="collapsed" href="#shoes"
                                                                             ...
                                                                             aria-expanded="false"
                                                                             aria-controls="shoes">{{$value->name}}<span
                                                    ...
                                                    <div class="widget widget-links cz-filter">
                                                        ...
                                                        <ul class="widget-list cz-filter-list pt-1"
                                                            ...
                                                            <li class="widget-list-item cz-filter-item"><a
                                                                    ...
                                                                    href="{{route('product-list',$child->slug)}}"><span
                                                                        class="cz-filter-item-text">{{$child->name}}</span><span
                                                                        class="font-size-xs text-muted ml-3">9</span></a>
                                                            </li>
                                                            @foreach($child->subCategory as $value2)
                                                                <li class="widget-list-item pb-1">
                                                                    <a class="widget-list-link"
                                                                       href="{{route('product-list',$value2->slug)}}">{{$value2->name}}</a>
                                                                </li>
                                                            @endforeach
                                                        </ul>
                        ...
                        <div class="widget mb-4 pb-4 border-bottom">
                            ...
                            <div class="cz-range-slider product_filter" data-start-min="0" data-start-max="30000"
                                 data-min="0" data-max="30000" data-step="1">
                                ...
                                <div class="d-flex pb-1">
                                    <div class="w-50 pr-2 mr-2">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input
                                                class="product_filter price_filter_min form-control cz-range-slider-value-min"
                                                type="text">
                                        </div>
                                    </div>
                                    <div class="w-50 pl-2">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input
                                                class="product_filter price_filter_max form-control cz-range-slider-value-max"
                                                type="text">
                                        </div>
                                    </div>
                                </div>
                                ...
                                @foreach($brand as $value1)
                                    <li class="cz-filter-item d-flex justify-content-between align-items-center mb-1">
                                        <div class="custom-control custom-checkbox">
                                            <input class="product_filter brand_filter custom-control-input"
                                                   type="checkbox" id="{{'brand'.$value1->id}}" value="{{$value1->id}}">
                                            <label class="custom-control-label cz-filter-item-text"
                                                   for="{{'brand'.$value1->id}}">{{$value1->brand_name}}</label>
                                        </div>
                        ...
                        <div class="widget cz-filter mb-4 pb-4 border-bottom">
                            ...
                            <ul class="widget-list cz-filter-list list-unstyled pt-1" style="max-height: 12rem;"
                                ...
                                @foreach($size as $value)
                                    <li class="cz-filter-item d-flex justify-content-between align-items-center mb-1">
                                        <div class="custom-control custom-checkbox">
                                            <input class="product_filter size_filter custom-control-input" name="size[]"
                                                   type="checkbox" id="{{$value->id}}" value="{{$value->id}}">
                                            <label class="custom-control-label cz-filter-item-text"
                                                   for="{{$value->id}}">{{$value->title}}</label>
                                        </div>
                                        <span class="font-size-xs text-muted">{{$value->count()}}</span>
                                    </li>
                                @endforeach
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="form-inline flex-nowrap mr-3 mr-sm-4 pb-3">
                            ...
                            <select class="item_sort form-control custom-select" id="sorting">
                                ...
                                class="font-size-sm text-light opacity-75 text-nowrap ml-2 d-none d-md-block">of 287 products</span>
                        </div>
                    </div>
                        ...
                        @foreach($products as $value)
                            ...
                            <div class="col-md-4 col-sm-6 px-2 mb-4">
                                <div class="card product-card">
                                    <button id="product_wishlist" class="btn-wishlist btn-sm" type="button"
                                            data-toggle="tooltip" data-placement="left" title="Add to wishlist"><i
                                            class="czi-heart"></i></button>
    ...
    <div class="cz-handheld-toolbar">
        <div class="d-table table-fixed w-100"><a class="d-table-cell cz-handheld-toolbar-item" href="#shop-sidebar"
                        ...
                        class="czi-filter-alt"></i></span><span class="cz-handheld-toolbar-label">Filters</span></a><a
                class="d-table-cell cz-handheld-toolbar-item" href="account-wishlist.php"><span
