            ...
            <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                        ...
                        <li class="breadcrumb-item text-nowrap active" aria-current="page">Popular Products</li>
                    </ol>
                </nav>
            </div>
            <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
                <h1 class="h3 text-light mb-0">Popular Products</h1>
            </div>
        </div>
    </div>
    <!-- Page Content-->
            ...
            <section class="col-lg-8">
                ...
                <div class="row mx-n2" id="product_filter_result">
                    ...
                    @if($popular->isNotEmpty())
                        @foreach($popular->take(6) as $value)
                ...
                <div class="row mx-n2">
                    <!-- Product-->
                    @foreach($popular->skip(6) as $value)
                        <input type="hidden" id="product_id" value="{{$value->id}}">
                        <div class="col-md-4 col-sm-6 px-2 mb-4">
                            <div class="card product-card">
                                <button id="product_wishlist" class="btn-wishlist btn-sm"  type="button" data-toggle="tooltip" data-placement="left" title="Add to wishlist"><i class="czi-heart"></i></button>
