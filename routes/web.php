...
//    Route::get('api/dependent-dropdown','CheckoutController@add_location');
//    Route::get('api/get-state-list','CheckoutController@getStateList');
//    Route::get('api/get-city-list','CheckoutController@getCityList');
...
//Shipping
    Route::group(['prefix' => 'shipping'], function () {
        ...
        Route::any('deal-status', 'ShippingController@deal_status')->name('deal-status');
